PRODUCT_COPY_FILES += packages/apps/trigtop/sys_copy/system/vendor/trigtop/modules/netxeon_nixie/netxeon_nixie.ko:system/vendor/trigtop/modules/netxeon_nixie/netxeon_nixie.ko
...
PRODUCT_COPY_FILES += packages/apps/trigtop/sys_copy/system/bin/preinstallApks.sh:system/bin/preinstallApks.sh
PRODUCT_COPY_FILES += packages/apps/trigtop/sys_copy/system/media/bootanimation.zip:system/media/bootanimation.zip