package com.netxeon.lignthome.circleprogress;
...
public class ArcProgress extends View {
    ...
    protected void initPainters() {
        ...
        textPaint.setColor(textColor);//颜色
        ...
        paint.setStrokeCap(Paint.Cap.ROUND);//线条覆盖样式
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(rectF, startAngle, arcAngle, false, paint);//画圆了
